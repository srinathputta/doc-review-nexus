...
const statusStyles = {
  ...
  basic_extracted: "bg-orange-100 text-orange-800",
  ...
  pending_sample_review: "bg-gray-100 text-gray-800",
  ...
  error_summary_review: "bg-red-100 text-red-800",
...
const statusLabels = {
  ...
  basic_extracted: "Basic Data Extracted",
  ...
  pending_sample_review: "Pending Sample Review",
  ready_for_indexing: "Ready for Indexing",
  indexing_in_progress: "Indexing",
  indexed: "Indexed",
  error: "Error",
  error_summary_review: "Summary Review Error",
